...
![https://damnfineprint.com/pages/risograph-guidelines](04-riso-grids/riso-process-2.jpeg)
...
Risograph
  ...
  https://damnfineprint.com/pages/risograph-guidelines
...
- https://peacock.studio/shopping/products/risograph-colour-chart-a5
- https://creativemarket.com/blog/risograph-printing
- https://www.monikerpress.ca/printing/

 A Risograph builds a print layer by layer, layering one color on top of another, resulting in a crisp but slightly imperfect print every time. While the print is imperfect, many artists believe its imperfect nature only adds charm and style to the distinct look a Risograph print has. 
...
#| out-width: 50%
#| fig-align: center
knitr::include_graphics("04-riso-grids/layer-1-ontop.jpg")
```
...
![](04-riso-grids/riso-grid-18.png)

:::

::: {.column}

![](04-riso-grids/riso-output.png)
